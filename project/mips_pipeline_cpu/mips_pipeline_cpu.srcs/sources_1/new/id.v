...
module id(
    ...
    always @(*) begin
        ...
        case (op)
            ...
            `OP_BEQ: begin
                ...
                reg_re2_o <= `ReadEnable;
                reg_raddr2_o <= opnd_rt;
                if (reg_rdata1_i == reg_rdata2_i) begin
                    branch_flag_o <= `True;
    ...
    always @(*) begin
        ...
        end else if (reg_re1_o == `ReadEnable) begin
            alu_opnd1_o <= reg_rdata1_i;
        end else if (reg_re1_o == `ReadDisable) begin
            alu_opnd1_o <= imm;
        end else begin
            alu_opnd1_o <= `ZeroWord;
        end
    ...
    always @(*) begin
        ...
        end else if (reg_re2_o == `ReadEnable) begin
            alu_opnd2_o <= reg_rdata2_i;
        end else if (reg_re2_o == `ReadDisable) begin
            alu_opnd2_o <= imm;
        end else begin
            alu_opnd2_o <= `ZeroWord;
        end
